<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <h2 class="mt-1 text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">Nuevo rol</h2>
        </div>
    </x-slot>
            ...
            <div class="ui-form-card">
                <form method="post" action="{{ route('roles.store') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <x-text-input id="name" name="name" value="{{ old('name') }}" class="mt-1 block w-full" required placeholder="ej: vendedor" />
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-2 space-y-2 max-h-64 overflow-y-auto border border-gray-200 rounded p-3">
                            ...
                            <label class="flex items-center">
                                <input type="checkbox" name="permissions[]" value="{{ $perm->id }}" {{ in_array($perm->id, old('permissions', [])) ? 'checked' : '' }} class="rounded border-gray-300">
