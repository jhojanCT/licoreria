<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <h2 class="mt-1 text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">Editar proveedor</h2>
        </div>
    </x-slot>
                ...
                <form method="post" action="{{ route('suppliers.update', $supplier) }}">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="notes" name="notes" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">{{ old('notes', $supplier->notes) }}</textarea>
                        </div>
                    </div>
