<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <h2 class="mt-1 text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">Nuevo usuario</h2>
        </div>
    </x-slot>
            ...
            <div class="ui-form-card">
                <form method="post" action="{{ route('users.store') }}">
                    ...
                    <div class="mt-6 flex gap-2">
                        ...
                        <a href="{{ route('users.index') }}" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-medium text-gray-700 hover:bg-gray-50">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
